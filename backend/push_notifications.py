...
# This bypasses environment variables to test if they are the problem.
vapid_keys = Vapid.from_new()
...
def get_vapid_public_key() -> str:
    ...
    return vapid_keys.public_key_b64
    ...
    for sub in list(subscriptions_in_memory):
        try:
            webpush(
                ...
                # Use the in-memory private key for this diagnostic test.
