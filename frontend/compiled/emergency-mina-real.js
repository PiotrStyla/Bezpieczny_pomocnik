...
import { MinaIntegrationFactory } from './mina-real-integration';
/**
 * 🔗 REAL MINA EMERGENCY MANAGER
 */
export class RealMinaEmergencyManager {
    constructor(contractAddress = 'B62qkYa1o6Mj6uTTjDQCob7FYZspuhkm4RRQhgJg9j4koEBWiSrTQrS') {
        this.minaClient = null;
        this.isConnected = false;
        this.parentPrivateKey = null;
        this.childCommitment = null;
     ...
     */
    async initializeRealMina() {
        try {
            console.log('🌐 Connecting to real Mina Protocol...');
            this.minaClient = await MinaIntegrationFactory.createRealIntegration(this.contractAddress);
     ...
     */
    async realRegisterChild(birthYear, parentWorldIDNullifier) {
        if (!this.minaClient || !this.isConnected) {
        ...
        try {
            ...
            const txHash = await this.minaClient.registerChild(birthYear, worldIDNullifier, this.parentPrivateKey);
    ...
    async simulationRegistration(birthYear) {
...
//# sourceMappingURL=emergency-mina-real.js.map